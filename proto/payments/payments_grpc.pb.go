...
func (UnimplementedPaymentServiceServer) ConfirmPaymentIntent(context.Context, *ConfirmPaymentIntentRequest) (*PaymentIntent, error) {
	return nil, status.Error(codes.Unimplemented, "method ConfirmPaymentIntent not implemented")
}
func (UnimplementedPaymentServiceServer) RefundPaymentIntent(context.Context, *RefundPaymentIntentRequest) (*PaymentIntent, error) {
	return nil, status.Error(codes.Unimplemented, "method RefundPaymentIntent not implemented")
}
